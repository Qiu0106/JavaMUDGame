...
public abstract class Scene{
    ...
    //进入场景
    public abstract void enter(Programmer programmer);
    //退出场景
    public static void exit(){
        System.out.println("离开 " + sceneName + "，返回大厅...");
    }
...
class Library extends Scene{
    ...
    public void enter(Programmer programmer) {
        printHeader();
        System.out.println("这里的空气中弥漫着咖啡和墨水的味道。");
        System.out.println("管理员: \"保持安静，多看文档，少写Bug。\"");

        // 核心功能：训练
        programmer.train();

        // 核心功能：回血
        if (programmer.getHp() < programmer.getMaxHp()) {
            programmer.takeDamage(-20); // 负数加血
            System.out.println(">> 在知识的海洋里遨游，你的心情平复了，发量略微恢复。");
        } else {
            System.out.println(">> 你的精神状态很好，不需要休息。");
        }
